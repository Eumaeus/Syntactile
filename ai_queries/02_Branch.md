...
## Branching Before We Move On

The current functionality of the app is terrific, and the next changes may be big.

It seems appropriate to do this in a branch of the GitHub repository.
